...
export default function AboutTheEventOrganiserPage() {
  return (
    <main id="main-content" className="relative min-h-[100svh] overflow-hidden bg-background">
      ...
      <Container className="relative section-y">
        ...
        <p className="eyebrow mt-12 md:mt-16">The Event Organiser</p>
